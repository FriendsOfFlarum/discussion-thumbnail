...
__webpack_require__(/*! ./shim */ "./node_modules/object.assign/shim.js")();
...
/***/ "./src/forum/components/DiscussionThumbnail.js":
/*!*****************************************************!*\
  !*** ./src/forum/components/DiscussionThumbnail.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DiscussionThumbnail; });
...
/* harmony import */ var object_assign_auto__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! object.assign/auto */ "./node_modules/object.assign/auto.js");
/* harmony import */ var object_assign_auto__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(object_assign_auto__WEBPACK_IMPORTED_MODULE_4__);
...
var DiscussionThumbnail =
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(DiscussionThumbnail, _Component);

  function DiscussionThumbnail() {
    return _Component.apply(this, arguments) || this;
  }

  var _proto = DiscussionThumbnail.prototype;
  ...
  _proto.view = function view() {
    var attrs = Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, this.attrs.elementAttrs);

    var loaded = loadedSet.has(this.attrs.src);
    ...
    }, !loaded && m(flarum_common_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_3___default.a, null), m("img", attrs));
  };

  _proto.configImage = function configImage(vnode) {
  ...
  _proto.onLoad = function onLoad(evt) {
    var img = evt.target;
...
/* harmony import */ var _components_DiscussionThumbnail__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/DiscussionThumbnail */ "./src/forum/components/DiscussionThumbnail.js");
...
var find = function find(obj, clazz) {
  return obj && obj.children && obj.children.filter(function (e) {
    return lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(e, 'attrs.className', '').indexOf(clazz) !== -1;
  })[0];
};

app.initializers.add('fof/discussion-thumbnail', function () {
  flarum_common_models_Discussion__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.customThumbnail = flarum_common_Model__WEBPACK_IMPORTED_MODULE_2___default.a.attribute('customThumbnail');
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_forum_components_DiscussionListItem__WEBPACK_IMPORTED_MODULE_4___default.a.prototype, 'view', function (vdom) {
    var image = this.attrs.discussion.customThumbnail();
    if (!image) return;
    var content = find(vdom, 'DiscussionListItem-content');
    var author = find(content, 'DiscussionListItem-author');
    var avatar = find(author, 'Avatar');
    if (!avatar) return;
    delete avatar.attrs.src;
    author.children[author.children.indexOf(avatar)] = m(_components_DiscussionThumbnail__WEBPACK_IMPORTED_MODULE_5__["default"], {
      elementAttrs: avatar.attrs,
      src: image
    });
  });
});
